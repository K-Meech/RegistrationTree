...
public class test_similarity_reader_3d {
    ...
    public static void main( String[] args )
    {
        ...
        try {
            ...
            final SpimData fixed = new XmlIoSpimData().load( "C:\\Users\\meechan\\Documents\\sample_register_images\\similarity3d\\mri-stack.xml");
            final SpimData moving = new XmlIoSpimData().load("C:\\Users\\meechan\\Documents\\sample_register_images\\similarity3d\\rotated-scaled.xml");
            final SpimData corrected = new XmlIoSpimData().load("C:\\Users\\meechan\\Documents\\sample_register_images\\similarity3d\\mri-stack.xml");
            bdv = null;
            ...
            ElastixTransform elastixTransform = ElastixTransform.load( new File("C:\\Users\\meechan\\Documents\\temp\\elatix_checks\\similarityimpl\\similarity_proper_test_3d\\TransformParameters.0.txt" ));
            AffineTransform3D bdvTransform = ElastixSimilarity3DToAffineTransform3D.convert( (ElastixSimilarityTransform3D) elastixTransform);
