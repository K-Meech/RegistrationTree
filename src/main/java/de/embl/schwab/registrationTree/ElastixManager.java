...
import de.embl.schwab.registrationTree.mhd.MhdHeader;
import de.embl.schwab.registrationTree.mhd.MhdHeaderParser;
...
import de.embl.schwab.registrationTree.ui.CropperUI;
import de.embl.schwab.registrationTree.ui.DownsamplingUI;
import de.embl.schwab.registrationTree.ui.ElastixUI;
...
public class ElastixManager {
    ...
    public void exportElastixResultToRegTree(String fixedCropName, String movingCropName, int fixedLevel, int movingLevel ) {
        ...
        try {
            ...
            if ( contains ) {
                ...
                throw new UnsupportedOperationException("Transform type unsupported in Registration Tree!");
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
